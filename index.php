...
<head>
    ...
    <style>
        body{
            background: radial-gradient(circle, rgba(224,17,255,1) 0%, rgba(0,144,127,1) 100%);
...
<body>
    ...
    <div id="carta" >
    <h1 class="center white-text">¡Bienvenido/a!</h1><br>
                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="input-field">
                            ...
                            <br>
                            <div class="center ">
                            <button class="btn waves-effect waves-light  #004d40 teal darken-4" type="submit">Iniciar Sesión
